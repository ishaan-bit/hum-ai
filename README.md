...
- **Stable Build v14 — latest release spec (end-to-end QA/QC stabilization: a state→KPI→parameter→wiring audit that isolates recording-fidelity from the personalization/OCEAN/drift layers, makes the mood-field zone a strict coarsening of the headline, revives dead inner-state/trajectory branches, damps lone-hum risk escalation, and adds a Sound Lab taste-coherence taxonomy):** [docs/STABLE_BUILD_V14.md](docs/STABLE_BUILD_V14.md) · [ADR-0016](docs/adr/0016-state-kpi-wiring-audit-fidelity-isolation.md) · earlier specs: [v13](docs/STABLE_BUILD_V13.md) (unsupervised within-hum chunking + vocal-range model) · [v12](docs/STABLE_BUILD_V12.md) (within-hum temporal trajectory) · [v11](docs/STABLE_BUILD_V11.md) (trait-decoupling) … [v2](docs/STABLE_BUILD_V2.md)
